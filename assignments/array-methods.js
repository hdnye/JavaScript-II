...
function getNames(arrayItem) {
  console.log(`${arrayItem.first_name} ${arrayItem.last_name}`); 
}
...
function allCaps(arrayItems) {
  console.log(`${arrayItems.first_name.toUpperCase()}`);
}
runners.map(allCaps);
...
const getSize = runners.filter((type) => {
